...
<div class="row">
    ...
    <div>
        <input type="number" id="quantidade" name="quantidade" max="500"
...
<div class="row">
    ...
    @if (isset($produto))
        <div class="form-group col-md-6 col-sm-12">
            ...
            <div><img src="/storage/{{ $produto->imagem }}" alt="image Exemplo"
                    style="max-height: 430px; object-fit: cover;"></div>
        </div>
    @endif
</div>
